let bckColor=(clr)=>{document.querySelector('.textContainer').style.backgroundColor=clr}
...
let DownloadPic=()=>{
  html2canvas(document.getElementsByClassname('textContainer')).then(canvas=>{const link=document.createElement('a')
